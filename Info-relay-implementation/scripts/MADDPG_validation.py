...
if __name__ == "__main__":
    ...
    #env = Info_relay_env(num_agents = 1, num_bases = 1, max_iter=100, render_mode="rgb_array")
    env.reset()
    try:
    ...
    path = "./models/MADDPG/MADDPG_trained_agent3.pt"
    maddpg = MADDPG.load(path, device)
    #maddpg = MATD3.load(path, device)
